...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZmVyYXN0YWp1b3JlIiwiYSI6ImNrNzN2ZXRubTAyNDYzbHBhZzFvZHkzb3YifQ.7VU9G3uIp-dNwLD8OlpbJA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/ferastajuore/ck73vkqba25du1it82k47h1yd',
    scrollZoom: false // center: [-118.244064, 34.027674],
    // zoom: 4
...
var stripe = Stripe('pk_test_suX203we1fjtYTzhochYfexL00NofRZmZd');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "44363" + '/');
